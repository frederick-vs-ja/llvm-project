...
- P2587R3: ``to_string`` or not ``to_string`` (`Github <https://github.com/llvm/llvm-project/issues/105359>`__)
  (partially implemented, changes of overloads for ``long double`` missing on most platforms)
