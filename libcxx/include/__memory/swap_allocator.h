...
__swap_allocator(_Alloc& __a1, _Alloc& __a2, true_type) _NOEXCEPT {
  using std::swap;
  swap(__a1, __a2);
}
...
template <typename _Alloc>
inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX14 void __swap_allocator(_Alloc& __a1, _Alloc& __a2) _NOEXCEPT {
